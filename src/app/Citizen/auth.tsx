...
import { countries, states } from "@/constants/contries";
...
const Auth: React.FC = () => {
  ...
  const [formData, setFormData] = useState<Citizen | undefined>();
  ...
  return (
    <>
      ...
      <SafeAreaView />
      <ScrollView
        style={[styles(theme).container, { backgroundColor: theme.background }]}
      >
        {/* Profile Image */}
        <View style={styles(theme).inputGroup}>
          {profileImage ? (
            ...
            <TouchableOpacity onPress={pickProfileImage}>
              <View style={styles(theme).previewContainer}>
                <Image
                  source={require("@/assets/images/role/citizenProfile.png")}
                  style={styles(theme).imagePreview}
                />
              </View>
            </TouchableOpacity>
